...
A Chi-square test was conducted to test whether or not there is a significant relationship between drinking and health condition in the population of Oregon adults. The findings indicated that there was a significant relationship between personality type and color preference, $\chi^2$ = 18.611, p < .001.
