...
---
## Background: random teacher-student assignment trend
...
.highlighter01[Contributions]:
 ...
 - Findings on Chinese certified teachers largely confirm those in the western (e.g., US) education context:
   - Education background of English teacher does not matter; Chinese teacher's graduate degree and major seem to positively impact student learning but mainly on motivational aspect; math teacher's degree beyond bachelor negatively affects student performance
   - One extra year in teaching experience does not have causal impact on student learning. The most effective teachers are early career teachers, which is particularly true for English and math
...
.highlighter01[Policy implications] - "Education, Experience, or .highlighter02[More]?"
 ...
 - Calling for evidence-based, more comprehensive human resources policies looking at teacher attributes beyond human capital characteristics, some examples:
    - Teacher-student identity match (another paper tomorrow presented by Anwesha Guha)
    - Teacher social-emotional competencies
    - Culturally responsive teaching
    - .highlighter02[and more...]
---
class: center, middle
